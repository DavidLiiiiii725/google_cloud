...
Same format/shape as app/transport/events.py so all three agents' log lines render
identically in the unified UI.
"""
...
def emit(tag: str, message: str, **extra):
    ...
    entry = {"ts": time.time(), "tag": tag, "message": message, "agent": "merchant", **extra}
